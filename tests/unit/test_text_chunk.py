...
class TestTextChunkIdGeneration:
    ...
    def test_chunk_id_generation_uniqueness(self):
        ...
        chunk1 = TextChunk(
            content="Content", metadata={}, start_index=0, end_index=7, source_document="doc.pdf"
        )
    ...
    def test_chunk_id_generation_different_sources(self):
        ...
        chunk1 = TextChunk(
            content="Content", metadata={}, start_index=0, end_index=7, source_document="doc1.pdf"
        )
...
class TestTextChunkEdgeCases:
    ...
    def test_empty_content(self):
        ...
        chunk = TextChunk(
            content="", metadata={}, start_index=0, end_index=0, source_document="empty.pdf"
        )
    ...
    def test_zero_indices(self):
        ...
        chunk = TextChunk(
            content="", metadata={}, start_index=0, end_index=0, source_document="doc.pdf"
        )
